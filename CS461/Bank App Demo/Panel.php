...
echo htmlspecialchars($_SERVER["PHP_SELF"]);
?>" method="post">
Amount<br><input type="number" type="number" min = "0.00" step="0.01" name="depositamount" size="33" maxlength="10"> <input type="submit" value="Deposit" name="Deposit"><p>
Amount<br><input type="number" type="number" min = "0.00" step="0.01" name="withdrawamount" size="33" maxlength="10">  <input type="submit" value="Withdraw" name="Withdraw"><p>
